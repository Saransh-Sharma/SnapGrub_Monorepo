...
class ProfilesLocal extends Table {
  ...
  BoolColumn get cloudMediaStorage => boolean().withDefault(const Constant(true))();
  BoolColumn get saveOriginalPhotos => boolean().withDefault(const Constant(false))();
  BoolColumn get aiImprovementConsent => boolean().withDefault(const Constant(false))();
