...
Committed examples live under `packages/api-contracts/examples`.

Current examples:

- `profile-bootstrap.response.json`
- `profile-bootstrap.unauthenticated.response.json`
- `settings-patch.request.json`
