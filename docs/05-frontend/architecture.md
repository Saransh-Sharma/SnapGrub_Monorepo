...
- `features`: auth, onboarding, home, capture, photo analysis, barcode, text entry, voice entry, meal editor, journal, progress, templates, custom foods, insights, profile.
